...
$(document).on( 'click', function(){
	...
	$('.change-layout-theme a').click(function(){
		...
		if ( layoutTheme != '' ) {
			...
			$("#layout-theme").attr("href","assets/themes/minified/agileui/color-schemes/layouts/" + layoutTheme + ".min.css");

			$("#elements-theme").attr("href","assets/themes/minified/agileui/color-schemes/elements/" + elementsTheme + ".min.css");
...
function themefromCookie(){
	...
	if ( layoutThemefromCookie != null ) {
		...
		$("#layout-theme").attr("href","assets/themes/minified/agileui/color-schemes/layouts/" + layoutThemefromCookie + ".min.css");

	}

	if ( elementsThemefromCookie != null ) {

		$("#elements-theme").attr("href","assets/themes/minified/agileui/color-schemes/elements/" + elementsThemefromCookie + ".min.css");
