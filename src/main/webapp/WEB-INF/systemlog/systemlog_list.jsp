    ...
    <script type="text/javascript">
        ...
        var createTable = function(index, item,pageNow) {
            ...
            str=str+ (index + 1)
                ...
                + "</td>"
                + "<td>"
                + (item.oprationTime == null ? "" : item.oprationTime)
                + "</td>"
                + "<td>"
        ...
        var loadDataGird = function(selectType) {
            ...
            if(selectType==1){
//                表示点击查询按钮,初始化当前页为1
                url="${basepath }/systemlog/getlist?pageNow=1";
            }else{
                url="${basepath }/systemlog/getlist?pageNow="+${pageHelp.pageBean.pageNow};
            }
                ...
                success : function(data) {
                    ...
                    $('#pagination').twbsPagination({
                        ...
                        onPageClick : function(event, page) {
                            var selectname = $("#selectname").val();
                            $.ajax({
                                url : "${basepath }/systemlog/getlist",
                                type : "post",
                                data : {pageNow:page,content:selectname},
                                dataType : "json",
                                success : function(data) {
                                    $("#tbody").html("");
    ...
    <div class='col-md-12'>
        <form class="form-inline" role="form"
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="selectname" value="${pageHelp.selectStr}" placeholder="内容">
            </div>
    ...
    <div class='col-md-12'>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>操作类型</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>操作内容</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>操作时间</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>操作人</th>
            </tr>
            </thead>
            <tbody id="tbody">
