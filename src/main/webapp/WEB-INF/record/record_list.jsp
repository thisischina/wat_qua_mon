...
<head>
    ...
    <script type="text/javascript">
        ...
        var createTable = function(index, item,pageNow) {
            ...
            str=str+ "<td>"
                + "<div class=''>"
                + "<a class='btn btn-xs btn-info' href='../record/toupdate?id="+item.id
        ...
        var loadDataGird = function(selectType) {
            ...
            if(selectType==1){
//                表示点击查询按钮,初始化当前页为1
                url="${basepath }/record/getlist?pageNow=1";
            }else{
                url="${basepath }/record/getlist?pageNow="+${pageHelp.pageBean.pageNow};
            }
                    ...
                    success : function(data) {
                        ...
                        $('#pagination').twbsPagination({
                            ...
                            onPageClick : function(event, page) {
                                var content = $("#contentname").val();
                                $.ajax({
                                    url : "${basepath }/record/getlist",
                                    type : "post",
                                    data : {pageNow:page,content:content},
                                    dataType : "json",
                                    success : function(data) {
                                        $("#tbody").html("");
    ...
    <div class='col-md-12'>
        <form class="form-inline" role="form"
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="contentname" value="${pageHelp.selectStr}" placeholder="内容">
            </div>
    ...
    <div class='col-md-12'>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>维护人</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>维护时间</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>维护站点</th>
                <th class="text-center"  style='background:RGB(79,129,189);color:#fff'>维护设备</th>
