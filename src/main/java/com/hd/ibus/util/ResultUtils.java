...
import com.hd.ibus.result.ExceptionResultInfo;
import com.hd.ibus.result.ResultInfo;
import com.hd.ibus.result.SubmitResultInfo;
...
public class ResultUtils {
    ...
    public static ResultInfo createFail(String fileName,int messageCode,Object[] objs){
    	String message=null;
    	if(objs == null){
    		message = PropertiesUtils.getValue(fileName, messageCode+"");
    	}else{
    		message = PropertiesUtils.getValue(fileName, messageCode+"",objs);
    	}
